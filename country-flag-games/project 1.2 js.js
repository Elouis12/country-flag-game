...
let challengeAnswers = new Array("America",
   "Australia",
"Brazil",
"Canada",
"China",
...
randomChoices[0],
randomChoices[1],
randomChoices[2])// GRABS FIRST 3 RANDOM VALUES AS OTHER OPTIONS
...
function getPic(){
   ...
   while(a<=20){ 
      ...
      // while(buttonCount<=4){
         ...
         if(challengeAnswers[buttonCount-1] === 1){
         challengeAnswers[buttonCount-1] = randomChoices[3];
         }
         labelButtons(a,challengeAnswers[buttonCount-1],buttonCount+1); 
